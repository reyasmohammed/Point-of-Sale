...
class Receiving_stock extends CI_Controller{
   function __construct() {
    ...
    function data_table(){
        $aColumns = array( 'guid','code','branch_code','store_name','date','no_items','total_amount','stock_status' );	
	$start = "";
			$end="";
...
function  get_stock_transfer($guid){
    if($this->session->userdata['receiving_stock_per']['read']==1){
    $this->load->model('stock');
