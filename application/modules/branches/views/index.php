...
function posnic_branches_lists(){
      ...
      $('#posnic_add_branches').removeAttr("disabled");
      $('#branches_lists').attr("disabled",'disabled');
}
function clear_add_branches(){
                                       ...
                                       <div class="col col-sm-12" style="padding-left: 25px;padding-right: 25px;">
                                           <div class="row">
                                               <div class="col col-sm-4">
                                                   <div class="form_sep">
                                                        <label for="payment_type" ><?php echo $this->lang->line('branches_payment_type') ?></label>													
...
<section id="edit_customer_form" class="container clearfix main_section">
     <?php   $form =array('id'=>'parsley_reg',
                          'runat'=>'server',
                          'class'=>'form-horizontal');
       echo form_open_multipart('branches/upadate_pos_branches_details/',$form);?>
        <div id="main_content_outer" class="clearfix">
            <div id="main_content">
                    ...
                    <div  class="col-lg-6" style="padding:0px 25px;">
                     ...
                     <div  class="col-lg-6" style="padding:0px 25px;">
                      ...
                      <div class="col col-lg-12 text-center"><br><br>
                          <button id="update_branches"  type="submit" name="save" class="btn btn-default"><i class="icon icon-save"> </i> <?php echo $this->lang->line('update') ?></button>
